...
public class finish_school_certification extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_finish_school_certification);

        go_main_button = findViewById(R.id.go_main_button);
        go_main_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(finish_school_certification.this, MainActivity.class);
